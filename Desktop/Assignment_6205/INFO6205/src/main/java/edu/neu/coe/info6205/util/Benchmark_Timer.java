...
public class Benchmark_Timer<T> implements Benchmark<T> {
    ...
    public static void RandomSort() {
        ...
        for(int m = 0; m < 6; m ++) {
            ...
            Benchmark_Timer f = new Benchmark_Timer<>("MeasureRuningTimes", t ->{s.sort(list);}, null);
            System.out.println("Random Sort" + "\nThe number of elements:" + n + "\nRoutine Time:" + f.run(list,500));
        }
    }

    public static void OrderedSort() {
        int n = 20;
        for(int m = 0; m < 6; m ++) {
            n = n * 2;
            List<Integer> list = new ArrayList<>();
    ...
    public static void PartOrderedSort() {
        int n = 20;
        for(int m = 0; m < 6; m ++) {
            n = n * 2;
            List<Integer> list = new ArrayList<>();
            ...
            Benchmark_Timer f = new Benchmark_Timer<>("MeasureRuningTimes", t ->{s.sort(list);}, null);
            System.out.println("Partially Ordered Sort" + "\nThe number of elements:" + n + "\nRoutine Time:" + f.run(list,500));
        }
    }

    public static void ReversedSort() {
        int n = 20;
        for(int m = 0; m < 6; m ++) {
            n = n * 2;
            List<Integer> list = new ArrayList<>();
            ...
            Benchmark_Timer f = new Benchmark_Timer<>("MeasureRuningTimes", t ->{s.sort(list);}, null);
            System.out.println("Reversed Ordered Sort" + "\nThe number of elements:" + n + "\nRoutine Time:" + f.run(list,500));
        }
    }
